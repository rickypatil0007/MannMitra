    ...
    <AuthFormWrapper>
      ...
      <AuthSection className="space-y-4">
        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
          <Button
            className="w-full h-12 justify-start gap-3 bg-[var(--primary)] hover:bg-[var(--primary-hover)] text-[var(--primary-foreground)]"
            asChild
          >
        ...
        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
          <Button
            className="w-full h-12 justify-start gap-3 bg-[var(--surface)] hover:bg-[var(--danger-soft)] hover:border-[#FECACA] text-[var(--text-primary)] border border-[var(--border)] transition-colors"
            variant="outline"
            asChild
          >
