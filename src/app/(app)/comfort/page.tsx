...
const resources = [
  ...
  { title: "Overcoming Perfectionism", category: "Reading", icon: BookHeart, bg: "bg-[#FFF6ED]", iconColor: "text-[var(--accent-warm)]" },
  { title: "Morning Grounding", category: "Audio", icon: Coffee, bg: "bg-[#FFF8EE]", iconColor: "text-[var(--warning)]" },
];
    ...
    >
      ...
      <div className="rounded-2xl bg-[var(--primary-hover)] overflow-hidden relative">
        ...
        <div className="relative z-10 p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <Button className="bg-[var(--primary-soft)] text-[var(--primary-hover)] hover:bg-[var(--surface)] font-semibold shrink-0 h-12 px-6">
            Open Campus Map
          </Button>
        </div>
      </div>
